      ...
      >
        {options.map((option) => (
          <RadioGroupPrimitive.Item
            ...
            className={clsx(
              'group relative box-content h-8 w-8 rounded-full border-2 p-0.5 transition-colors hover:border-contrast-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:hover:border-transparent data-[disabled]:pointer-events-none data-[state=checked]:border-background [&:disabled>.disabled-icon]:grid',
