      ...
      {(logo) => (
        ...
        >
          {typeof logo === 'object' && logo !== null && logo.src !== '' ? (
            ...
            typeof logo === 'string' && (
              <span className="text-white font-[family-name:var(--logo-font-family,var(--font-family-heading))] text-lg font-semibold leading-none text-[var(--logo-text,hsl(var(--foreground)))] @xl:text-2xl">
                {logo}
              </span>
            )
          )}
