        ...
        <li>
          {startCursor != null ? (
            <PaginationLink
              ...
              scroll={scroll}
            >
              <ArrowLeft size={24} color="#fff" strokeWidth={1} />
            </PaginationLink>
          ) : (
            <SkeletonLink>
              <ArrowLeft size={24} color="#fff" strokeWidth={1} />
        ...
        <li>
          {endCursor != null ? (
            <PaginationLink
              ...
              scroll={scroll}
            >
              <ArrowRight size={24} color="#fff" strokeWidth={1} />
            </PaginationLink>
          ) : (
            <SkeletonLink>
              <ArrowRight size={24} color="#fff" strokeWidth={1} />
...
})
{
  return (
    <Link
      aria-label={ariaLabel}
      className={clsx(
        'flex h-12 w-12 items-center justify-center rounded-full border border-contrast-100 text-foreground ring-primary transition-colors duration-300 hover:border-contrast-200 hover:bg-[#232323] focus-visible:outline-0 focus-visible:ring-2',
      )}
      href={href}
      scroll={scroll}
    >
