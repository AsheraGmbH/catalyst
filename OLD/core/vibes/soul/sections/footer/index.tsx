                        ...
                        <ul>
                          {links.map((link, idx) => {
                            return (
                              <li key={idx}>
                                <Link
                                  className={`${link.classNames} block rounded-lg py-2 text-sm font-medium text-[var(--footer-link,hsl(var(--contrast-400)))] ring-[var(--footer-focus,hsl(var(--primary)))] transition-colors duration-300 hover:text-[#EDEDED] focus-visible:outline-0 focus-visible:ring-2`}
                                  href={link.href}
                                >
                                  {link.label}
                                </Link>
