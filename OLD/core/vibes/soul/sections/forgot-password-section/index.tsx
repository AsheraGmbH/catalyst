...
{
  return (
    <div className="@container bg-asheraBackground">
      <div className="flex flex-col justify-center gap-y-24 px-3 py-10 @xl:flex-row @xl:px-6 @4xl:py-20 @5xl:px-20">
        <div className="flex w-full flex-col @xl:max-w-md @xl:pr-10 @4xl:pr-20">
          <h1 className="mb-5 text-4xl text-white font-medium leading-none @xl:text-5xl">{title}</h1>
          <p className="mb-10 text-base text-[#b7b7b7] font-light leading-none @xl:text-lg">{subtitle}</p>
