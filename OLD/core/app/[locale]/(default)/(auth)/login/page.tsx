...
export default async function Login()
{
  ...
  return (
    ...
    >
      <div className="">
        <h3 className="mb-3 text-xl text-white font-bold lg:text-2xl">{t('CreateAccount.heading')}</h3>
        <p className="text-base text-white font-semibold">{t('CreateAccount.accountBenefits')}</p>
        <ul className="mb-4 text-[#B3B3B3] list-disc ps-4">
